...
public class ButtonFactory
{
    ...
    {
        #if ELECTROPLASMATIC_MOBILE_INPUT // Definida en propiedades del proyecto
            return new TouchButton(); // Esto si detecta multitouch
        #else
        // click button always works as a tap button // --> si, pero esto no detecta multitouch
